...
export const BeerItem = ({name, image_url, tagline, abv, description, first_brewed, food_pairing}) => {
            ...
            <div className={style.infoContainer}>
                ...
                <div className={style.description}>
                    ...
                    <ol className={style.list}>
                        {food_pairing.map((item,index) => <li key={index} className={style.listItem}>{item}</li>)}
                    </ol>
                </div>
            </div>
        </div>
