...
export const AllBeerPage = () => {
    ...
    const filterBeers = useMemo(() => {
        ...
        return beers.filter(item => item.name.toUpperCase().includes(filter.toUpperCase()))
    }, [filter, beers]);
    ...
    return <div className={style.container}>
            ...
            <input className={style.input} value={filter} onChange={(e)=> setFilter(e.target.value)}/>
            <Table
                data={filterBeers}
